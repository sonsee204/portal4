...
import { OtpTestUserGrantTable } from './OtpTestUserGrantTable';
...
const OTP_GRANT_SORT_FIELDS = ['phone', 'createdAt', 'expiresAt'] as const;
...
export function OtpTestUserGrantSettings() {
  ...
  const { sortField, sortDir, handleSort } = useDataTableSortUrl({
    allowedFields: OTP_GRANT_SORT_FIELDS,
    defaultField: 'createdAt',
    defaultDir: 'desc',
    sortParam: 'otpGrantSort',
    dirParam: 'otpGrantDir',
  });
