...
function OtpTestPhoneSettingsContent() {
  ...
  const purposesValue =
    dialogMode === 'create' ? createPurposes : editPurposes;
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between px-1">
        <div>
          ...
          <p className="text-faint text-xs">{OTP_TEST_PHONES.SECTION_DESCRIPTION}</p>
        </div>
        <Button
          variant="primary"
          size="sm"
      ...
      <QueryState loading={loading} error={error ?? undefined} onRetry={() => void load()}>
        <DataTable
          columns={columns}
          data={items}
          renderRow={renderRow}
